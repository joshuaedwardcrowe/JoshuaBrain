...
metadata: 
  ...
  modified: 2026-08-01T08:37:11.613Z
---
...
- **Project #8 scope** (per user, 2026-07-28): represents commands that **analyse** YNAB data or do **CRUD** operations on it. CRUD is scoped strictly to milestone **"CRUD" (#3)** (per user, 2026-08-01) — per-record create/read/update/delete. Structural re-shaping of a budget is *not* CRUD and belongs to milestone **"Reorganising Budget Structure" (#11)**; see [[project-spendfulnesscli-reorganisation-usecase]]. Other user projects exist but are unexplored: #5 "Creating a Proof of Concept", #2 "Adding Settings", #1 "Tech Debt Monitoring" — likely narrower/different scopes.
