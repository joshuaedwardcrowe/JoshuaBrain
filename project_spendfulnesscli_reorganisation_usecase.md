...
metadata: 
  ...
  modified: 2026-08-01T08:34:05.595Z
---
...
**How to apply:** This work lives in its own milestone, **"Reorganising YNAB Data" (#11)** — structural re-shaping of an existing budget. Keep it distinct from its sibling **"Modifying YNAB Data" (#3)**, which is per-record edits: splits, sanitizing, account naming schemes. When scoping or prioritising work in this repo, treat bulk category/group/transaction re-assignment as a target capability and check whether a proposed change helps or blocks it.
